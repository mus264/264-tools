...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 675.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 45.0, 190.0, 31.0 ],
									"text" : "interp #1-rvrb-size-tab off, priority #1-rvrb-size-tab -1"
								}
...
,
					"patching_rect" : [ 315.0, 735.0, 92.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 705.0, 199.0, 20.0 ],
					"text" : "264.pattr-control #1-264rvrb~ audio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 645.0, 72.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 630.0, 256.0, 18.0 ],
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 765.0, 199.0, 33.0 ],
					"priority" : 					{
						"#1-rvrb-size-tab" : -1
					}
,
...
,
					"text" : "pattrstorage #1-264rvrb~ @changemode 0 @greedy 2",
					"varname" : "#1-264rvrb~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 465.0, 660.0, 59.5, 20.0 ],
					"restore" : 					{
						"#1-rvrb-decay-slider" : [ 37.352943 ],
						"#1-rvrb-dry-slider" : [ 0.0 ],
						"#1-rvrb-lowpass-slider" : [ 0.0 ],
						"#1-rvrb-size-tab" : [ 1.0 ],
						"#1-rvrb-wet-slider" : [ 0.0 ]
					}
,
					"text" : "autopattr",
					"varname" : "u284013078"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 630.0, 256.0, 165.0 ],
					"rounded" : 0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 195.0, 75.0, 57.0, 20.0 ],
									"text" : "pipe 300"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 5,
									"outlettype" : [ "bang", "float", "int", "float", "float" ],
									"patching_rect" : [ 15.0, 45.0, 259.0, 20.0 ],
									"text" : "t b 0.001 i 1. 0."
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 264.5, 107.0, 204.5, 107.0 ],
									"source" : [ "obj-4", 4 ]
								}
...
,
					"patching_rect" : [ 495.0, 375.0, 79.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 180.0, 525.0, 32.5, 20.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 330.0, 525.0, 32.5, 20.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 750.0, 105.0, 82.0, 20.0 ],
					"text" : "loadmess 0.3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 105.0, 79.0, 20.0 ],
					"text" : "loadmess 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 690.0, 246.0, 127.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 690.0, 60.0, 113.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 165.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 690.0, 135.0, 80.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 525.0, 75.0, 20.0 ],
					"text" : "clip 0.01 1.6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 495.0, 125.0, 20.0 ],
					"text" : "scale 0. 127. 0.01 1.6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 165.0, 119.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 585.0, 465.0, 36.0, 20.0 ],
					"text" : "t 115"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 540.0, 465.0, 31.0, 20.0 ],
					"text" : "t 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 495.0, 465.0, 31.0, 20.0 ],
					"text" : "t 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 495.0, 435.0, 154.0, 20.0 ],
					"text" : "sel 0 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 525.0, 225.0, 135.0, 20.0 ],
					"text" : "if $i1 < 85 then 1 else 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 495.0, 195.0, 171.0, 20.0 ],
					"text" : "if $i1 < 40 then 0 else out2 $i1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 300.0, 68.0, 20.0 ],
					"text" : "round 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 330.0, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 105.0, 72.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 60.0, 91.0, 33.0 ],
					"text" : "wet volume\n(0–127 / 0.–1.)",
					"textcolor" : [ 0.2, 0.286275, 0.298039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 165.0, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 270.0, 55.0, 20.0 ],
					"text" : "clip 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 330.0, 135.0, 80.0, 20.0 ],
					"text" : "route int float"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 246.0, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					"annotation" : "Volume of the “wet” reverb sound",
					"bgcolor" : [ 0.101961, 0.121569, 0.172549, 1.0 ],
					"bordercolor" : [ 0.252887, 0.278017, 0.300747, 1.0 ],
					"contdata" : 1,
					"hint" : "Volume of the “wet” reverb sound",
					"id" : "obj-101",
					"maxclass" : "multislider",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 300.0, 68.0, 20.0 ],
					"text" : "round 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 330.0, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 60.0, 91.0, 33.0 ],
					"text" : "dry volume\n(0–127 / 0.–1.)",
					"textcolor" : [ 0.2, 0.286275, 0.298039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 165.0, 105.0, 20.0 ],
					"text" : "scale 0. 1. 0. 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 270.0, 55.0, 20.0 ],
					"text" : "clip 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 180.0, 135.0, 80.0, 20.0 ],
					"text" : "route int float"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 246.0, 105.0, 20.0 ],
					"text" : "scale 0. 127. 0. 1."
				}
...
, 			{
				"box" : 				{
					"annotation" : "Volume of the direct audio input",
					"bgcolor" : [ 0.101961, 0.121569, 0.172549, 1.0 ],
					"bordercolor" : [ 0.252887, 0.278017, 0.300747, 1.0 ],
					"contdata" : 1,
					"hint" : "Volume of the direct audio input",
					"id" : "obj-54",
					"maxclass" : "multislider",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 915.0, 105.0, 82.0, 20.0 ],
					"text" : "loadmess 0.6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 855.0, 255.0, 49.0, 20.0 ],
					"text" : "* 1000."
				}
...
, 			{
				"box" : 				{
					"annotation" : "How bright is the reverb",
					"bgcolor" : [ 0.101961, 0.121569, 0.172549, 0.0 ],
					"bordercolor" : [ 0.252887, 0.278017, 0.300747, 1.0 ],
					"contdata" : 1,
					"hint" : "How bright is the reverb",
					"id" : "obj-110",
					"maxclass" : "multislider",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 930.0, 255.0, 125.0, 20.0 ],
					"text" : "scale 0.02 12. 0. 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.0, 225.0, 75.0, 20.0 ],
					"text" : "clip 0.02 12."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 855.0, 135.0, 80.0, 20.0 ],
					"text" : "route int float"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.0, 105.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.0, 195.0, 152.0, 20.0 ],
					"text" : "scale 0. 127. 0.02 12. 1.07"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 735.0, 225.0, 20.0 ],
					"text" : "Credits",
					"textcolor" : [ 0.2, 0.286275, 0.298039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 750.0, 225.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 630.0, 256.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 30.0, 660.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 690.0, 164.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 630.0, 256.0, 165.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 585.0, 121.0, 20.0 ],
					"text" : "reverberated signal",
					"textcolor" : [ 0.2, 0.286275, 0.298039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "signal to be reverberated",
					"id" : "obj-40",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 555.0, 919.0, 20.0 ],
					"text" : "poly~ 264.reverb-poly~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 330.0, 60.0, 91.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 1.0, 9.0, 5.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 480.0, 60.0, 109.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 110.0, 1.0, 9.0, 5.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"hint" : "signal to be reverberated",
					"id" : "obj-31",
					"maxclass" : "panel",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 180.0, 60.0, 91.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 40.0, 1.0, 9.0, 5.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 45.0, 1050.0, 570.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 895.0, 158.0, 1020.0, 158.0, 1020.0, 219.0, 864.5, 219.0 ],
					"source" : [ "obj-9", 1 ]
				}
