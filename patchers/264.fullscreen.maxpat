...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 165.0, 135.0, 20.0 ],
					"saved_object_attributes" : 					{
						"filename" : "264.fullscreen-parent",
						"parameter_enable" : 0
					}
,
					"text" : "js 264.fullscreen-parent"
				}

			}
, 			{
				"box" : 				{
					"annotation" : "Toggle fullscreen display on/off",
					"bgcolor" : [ 0.2, 0.286275, 0.298039, 1.0 ],
					"bordercolor" : [ 0.301961, 0.337255, 0.403922, 0.0 ],
					"checkedcolor" : [ 0.980392, 0.988235, 0.976471, 1.0 ],
					"hint" : "Toggle fullscreen display on/off",
					"id" : "obj-5",
					"maxclass" : "toggle",
					"numinlets" : 1,
					"numoutlets" : 1,
					...
					"presentation" : 1,
					"presentation_rect" : [ 26.0, 27.0, 30.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 15.0, 65.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -3.0, 9.0, 66.0, 23.0 ],
					"text" : "SCREEN",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 60.0, 174.0, 20.0 ],
					"text" : "Toggle fullscreen on/off (1/0)",
					"textcolor" : [ 0.2, 0.286275, 0.298039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 225.0, 134.0, 20.0 ],
					"text" : "fullscreen status (1/0)",
					"textcolor" : [ 0.2, 0.286275, 0.298039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "Toggle fullscreen on/off (1/0)",
					"id" : "obj-7",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 45.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, -3.0, 62.0, 23.0 ],
					"text" : "FULL",
					"textcolor" : [ 0.2, 0.286275, 0.298039, 0.25 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					"background" : 1,
					"bgcolor" : [ 0.984314, 0.819608, 0.05098, 1.0 ],
					"hint" : "Toggle fullscreen on/off (1/0)",
					"id" : "obj-77",
					"maxclass" : "panel",
					"numinlets" : 1,
					"numoutlets" : 0,
