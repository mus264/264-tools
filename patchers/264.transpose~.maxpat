...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.0, 15.0, 101.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 540.0, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 570.0, 205.0, 20.0 ],
					"text" : "264.pattr-control #1-264trans~ audio"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 480.0, 256.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 600.0, 205.0, 33.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage #1-264trans~ @changemode 0 @greedy 2",
					"varname" : "#1-264trans~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 465.0, 510.0, 59.5, 20.0 ],
					"restore" : 					{
						"#1-trans-amount-slider" : [ 0.0 ]
					}
,
					"text" : "autopattr",
					"varname" : "u180009741"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 480.0, 256.0, 165.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 228.0, 105.0, 27.0, 20.0 ],
					"text" : "t 0."
				}
...
, 			{
				"box" : 				{
					"annotation" : "Reset transposition",
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 228.0, 75.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 158.0, 32.0, 20.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 165.0, 116.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 270.0, 345.0, 63.0, 20.0 ],
					"text" : "change 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 315.0, 46.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 107.62738, 33.0, 49.372616, 18.0 ],
					"text" : "0.00 st",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 255.0, 68.0, 20.0 ],
					"text" : "round 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 285.0, 93.0, 20.0 ],
					"text" : "sprintf set %f st"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 197.0, 62.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 34.0, 62.0, 17.0 ],
					"text" : "A M O U N T",
					"textcolor" : [ 0.980392, 0.988235, 0.976471, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 60.0, 156.0, 33.0 ],
...
, 			{
				"box" : 				{
					"comment" : "transposition, in semitones (0–127 / -36.–36.)",
					"id" : "obj-19",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"annotation" : "How many semitones the original sound is transposed",
					"bgcolor" : [ 0.101961, 0.121569, 0.172549, 1.0 ],
					"bordercolor" : [ 0.252887, 0.278017, 0.300747, 1.0 ],
					"contdata" : 1,
					"hint" : "How many semitones the original sound is transposed",
					"id" : "obj-25",
					...
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 32.0, 121.0, 20.0 ],
					"setminmax" : [ -36.0, 36.0 ],
					"setstyle" : 1,
					"signed" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 480.0, 256.0, 165.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 125.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 5.0, 125.0, 23.0 ],
					"text" : "T R A N S P O S E",
...
, 			{
				"box" : 				{
					"comment" : "signal to be transposed",
					"id" : "obj-40",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 375.0, 114.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "pfft~ 264.transpose-pfft~ 4096 8"
				}
...
, 			{
				"box" : 				{
					...
					"hint" : "transposition, semitones (0–127 / -36.–36.)",
					"id" : "obj-10",
					"maxclass" : "panel",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 45.0, 420.0, 420.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 310.0, 159.0, 396.0, 159.0, 396.0, 189.0, 279.5, 189.0 ],
					"source" : [ "obj-16", 1 ]
				}
