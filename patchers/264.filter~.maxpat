...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 555.0, 97.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 130.0, 180.0, 58.0 ],
									"text" : "priority #1-fltr-type-tab 0, priority #1-fltr-bypass-toggle 10, interp #1-fltr-type-tab off, interp #1-fltr-bypass-toggle off"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 525.0, 256.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 465.0, 555.0, 59.5, 20.0 ],
					"restore" : 					{
						"#1-fltr-Q-slider" : [ 0.0 ],
						"#1-fltr-bypass-toggle" : [ 0 ],
						"#1-fltr-frequency-slider" : [ 0.0 ],
						"#1-fltr-type-tab" : [ 2.0 ]
					}
,
					"text" : "autopattr",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 525.0, 256.0, 165.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 60.0, 375.0, 47.0, 20.0 ],
					"text" : "/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 840.0, 60.0, 97.0, 33.0 ],
					"text" : "bypass on/off\n(0 = off; 1 = on)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 840.0, 120.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 933.0, 150.0, 24.0, 20.0 ],
					"text" : "t 0"
				}
...
,
					"patching_rect" : [ 900.0, 210.0, 57.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 840.0, 180.0, 70.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -5.0, 0.0, 200.0, 195.0 ],
					"rounded" : 4
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 840.0, 150.0, 84.0, 20.0 ],
					"text" : "route int bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 840.0, 360.0, 77.0, 18.0 ],
					"text" : "edit_mode 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 840.0, 210.0, 46.0, 20.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.0, 105.0, 75.0, 20.0 ],
					"text" : "loadmess 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 105.0, 89.0, 20.0 ],
					"text" : "loadmess 0.44"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 735.0, 150.0, 72.0, 20.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 285.0, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 315.0, 46.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 122.0, 54.0, 57.0, 18.0 ],
					"text" : "1.00",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 375.0, 19.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 55.0, 87.0, 17.0 ],
					"text" : "Q",
					"textcolor" : [ 0.980392, 0.988235, 0.976471, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 465.0, 165.0, 98.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 345.0, 125.0, 20.0 ],
					"text" : "scale 0.01 10. 0. 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 255.0, 68.0, 20.0 ],
					"text" : "round 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 60.0, 109.0, 33.0 ],
					"text" : "filter Q\n(0–127 / 0.01–10.)",
					"textcolor" : [ 0.2, 0.286275, 0.298039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 225.0, 75.0, 20.0 ],
					"text" : "clip 0.01 10."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 465.0, 135.0, 80.0, 20.0 ],
					"text" : "route int float"
				}
...
, 			{
				"box" : 				{
					"comment" : "filter Q (0–127 / 0.01–10.)",
					"id" : "obj-70",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 195.0, 152.0, 20.0 ],
					"text" : "scale 0. 127. 0.01 10. 1.07"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 465.0, 375.0, 95.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 53.0, 142.0, 20.0 ],
					"setminmax" : [ 0.0, 127.0 ],
					"setstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 405.0, 38.0, 29.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 345.0, 51.0, 20.0 ],
					"text" : "round 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 375.0, 104.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 255.0, 285.0, 179.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 465.0, 87.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 240.0, 165.0, 98.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 330.0, 315.0, 104.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 60.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					"comment" : "filter frequency, in kHz (0–127 / 0.01–22.1)",
					"id" : "obj-10",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 240.0, 465.0, 95.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 32.0, 142.0, 20.0 ],
					"setminmax" : [ 0.0, 127.0 ],
					"setstyle" : 1,
...
, 			{
				"box" : 				{
					...
					"bwidthcolor" : [ 0.301961, 0.337255, 0.403922, 0.0 ],
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 285.0, 160.0, 80.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 645.0, 330.0, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 78.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 5.0, 78.0, 23.0 ],
					"text" : "F I L T E R",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 465.0, 102.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 30.0, 435.0, 86.5, 20.0 ],
					"text" : "biquad~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.0, 360.0, 83.0, 18.0 ],
					"text" : "edit_mode $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 45.0, 960.0, 465.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 125.0, 375.0, 240.0, 375.0, 240.0, 366.0, 318.0, 366.0, 318.0, 348.0, 450.0, 348.0, 450.0, 342.0, 474.5, 342.0 ],
					"source" : [ "obj-13", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 125.0, 375.0, 240.0, 375.0, 240.0, 366.0, 318.0, 366.0, 318.0, 348.0, 450.0, 348.0, 450.0, 255.0, 477.0, 255.0, 477.0, 252.0, 489.5, 252.0 ],
					"source" : [ "obj-13", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 849.5, 234.5, 654.5, 234.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 849.5, 502.0, 303.0, 502.0, 303.0, 502.0, 10.0, 502.0, 10.0, 270.0, 54.5, 270.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 69.5, 420.0, 246.0, 420.0, 246.0, 432.0, 249.5, 432.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 69.5, 405.0, 240.0, 405.0, 240.0, 252.0, 264.5, 252.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 654.5, 497.0, 303.0, 497.0, 303.0, 497.0, 21.0, 497.0, 21.0, 276.0, 54.5, 276.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 339.5, 360.0, 369.0, 360.0, 369.0, 400.0, 306.0, 400.0, 306.0, 400.0, 264.5, 400.0 ],
					"source" : [ "obj-61", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 474.5, 246.0, 444.0, 246.0, 444.0, 492.0, 216.0, 492.0, 216.0, 277.0, 195.5, 277.0 ],
					"source" : [ "obj-66", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 505.0, 157.0, 624.0, 157.0, 624.0, 219.0, 474.5, 219.0 ],
					"source" : [ "obj-67", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 744.5, 233.5, 654.5, 233.5 ],
					"source" : [ "obj-78", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 280.0, 158.0, 405.0, 158.0, 405.0, 219.0, 249.5, 219.0 ],
					"source" : [ "obj-9", 1 ]
				}
