...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 225.0, 215.0, 385.0, 166.0 ],
									"text" : "The volume slider sets the overall output level of the delay module.\n\nThe delay slider sets the amount of time the signal is delayed by.\n\nThe feedback slider sets how much of the delayed signal gets fed back into the system, creating gradually decaying echoes.\n\nThe filter frequency applies to a lowpass filter applied to the signal fed back into delay. Lower values prevent high-frequency feedback, and dull the frequency content of the delays."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 440.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 15.0, 215.0, 195.0, 195.0 ],
									"varname" : "264.delay~"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 140.0, 45.0, 45.0 ]
								}
