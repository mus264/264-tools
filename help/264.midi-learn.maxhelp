...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 120.0, 310.0, 316.0, 50.0 ],
									"presentation_rect" : [ 4.0, 199.0, 0.0, 0.0 ],
									"text" : "The 264.midi-learn module will display the controller number and MIDI channel of the controller you linked, and will start to output the controller’s data!"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 225.0, 260.0, 50.0, 21.0 ]
								}

							}
, 							{
								"box" : 								{
									"args" : [ "help-midi-learn" ],
									"id" : "obj-1",
									"maxclass" : "bpatcher",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 140.0, 210.0, 296.0, 21.0 ],
									"text" : "Move your knob/fader/etc. on your MIDI controller"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 140.0, 135.0, 214.0, 21.0 ],
									"text" : "Click on the 264.midi-learn module:"
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 234.5, 195.0, 105.0, 195.0, 105.0, 255.0, 222.0, 255.0, 222.0, 255.0, 234.5, 255.0 ],
									"source" : [ "obj-1", 0 ]
								}
