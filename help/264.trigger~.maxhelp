...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 15.0, 465.0, 70.0, 70.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 133.200012, 240.0, 76.0, 20.0 ],
									"style" : "",
									"text" : "loadmess 100."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 280.0, 210.0, 86.0, 21.0 ],
									"style" : "",
									"text" : "Play a sound"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "264.trigger~" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 5.0, 11.0, 620.0, 125.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 266.263245, 57.567627 ]
				}
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-3::obj-18::obj-32" : [ "help-envelope-ex-trg-timegate-num", "time-gate", 0 ],
